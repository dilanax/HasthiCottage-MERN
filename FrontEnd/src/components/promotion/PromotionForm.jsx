...
export default function PromotionForm({ onAdd, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: "error",
        title: "Oops...",
        text: error.response?.data?.message || "Error adding promotion",
      });
    }
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-8 py-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-bold" style={{ color: "#d3af37" }}>Create New Promotion</h2>
            <button
              type="button"
              onClick={onClose}
          ...
          <p className="text-gray-600 mt-2">Fill in the details to create a new promotion for your customers</p>
        </div>
